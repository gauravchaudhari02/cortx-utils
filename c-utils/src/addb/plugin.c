...
static void perfc_entity_states(struct m0_addb2__context *ctx,
...
static void perfc_entity_attrs(struct m0_addb2__context *ctx,
                               const uint64_t *v, char *buf) {
  if (v[0] == PEA_R_OFFSET)
...
static void perfc_function_tags(struct m0_addb2__context *ctx,
                                const uint64_t *v, char *buf) {
